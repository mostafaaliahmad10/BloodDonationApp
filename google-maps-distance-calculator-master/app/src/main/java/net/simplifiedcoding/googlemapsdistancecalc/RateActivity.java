...
public class RateActivity extends BaseActivityStaff {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //setContentView(R.layout.activity_rate);
        ...
        getLayoutInflater().inflate(R.layout.activity_rate, frameLayout);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                RateActivity.this.adapter.getFilter().filter(cs);
            }
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(RateActivity.this, RateActivityStars.class);
