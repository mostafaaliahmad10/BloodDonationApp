...
public class DonateStaffActivity extends BaseActivityStaff {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setContentView(R.layout.activity_donate_staff);

        getLayoutInflater().inflate(R.layout.activity_donate_staff, frameLayout);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                DonateStaffActivity.this.adapter.getFilter().filter(cs);
            }
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(DonateStaffActivity.this, DonateStaffButtonActivity.class);
